...
use super::{context::Params, texture::Texture, scene::{Scene, Mesh, Vertex, Sphere}};
...
impl RayTracer{
    pub fn new(device: &wgpu::Device, texture: &Texture,params_buffer: &wgpu::Buffer,scene: &Scene)->Self{
